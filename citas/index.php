  ...
  <div class="master-container my-4">
    ...
    <div class="container">
      ...
      <div class="row d-flex justify-content-end mt-2">
        <button type="button" class="btn btn-primary mb-4 w-25 text-success" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Nova cita</button>
      </div>
